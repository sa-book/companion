...
|-------------------------------------|-------------------------------|
| 3.1 Outlook |  No code for this Chapter   |
| 3.2 Dissimilarity measures to compare sequences | [Create example sequences](rChapter3-2.html) |
| 3.3 Alignment techniques |  [Optimal matching (OM)](rChapter3-3.html) |
| |  [Assigning costs to the alignment operations](rChapter3-3.html) |
| |  [Alignment-based extensions of OM](rChapter3-3.html) |
| 3.4 Nonalignment techniques |  Alternative metrics to align sequences |
| 3.5 Comparing dissilarity matrices | Mantel correlation for sequences |
| 3.6 Comparing sequences of different lenght | No code for this Chapter |
| 3.7	Beyond the standard full-sample pairwise sequence comparison | Alternative options to compare sequences |
| 3.8	Multidimensional sequence analysis | Expansion of the alphabet |
