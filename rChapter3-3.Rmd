...
The book covers the following alternatives for alignment-based OM: data-driven costs, dynamic Hamming distance, time-warp edit distance. The `TraMineR` documentation offers detailed explanation of how to implement these dissimilarity measures in the standard code presented here.  
